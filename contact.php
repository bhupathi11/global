    ...
    <section>
      <div class="container">
        ...
        <ul class="list-group list-group-flush">
          <li class="list-group-item">Name: '. $_POST['contact_name'] .'</li>
          <li class="list-group-item">Email: '. $_POST['contact_email'] .'</li>
          <li class="list-group-item">Contact: '. $_POST['contact_phone'] .'</li>
          <li class="list-group-item">Company: '. $_POST['contact_company'] .'</li>
          <li class="list-group-item">Message: '. $_POST['contact_message'] .'</li>
        </ul>
      </div>
      </div>
    </section>
